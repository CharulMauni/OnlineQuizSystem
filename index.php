...
?>
<!-- <script>
function validateForm() {var y = document.forms["form"]["name"].value; var mob=document.getElementsById('mob').value;	var letters = /^[A-Za-z]+$/;if (y == null || y == "") {alert("Name must be filled out.");return false;}var z =document.forms["form"]["college"].value;if (z == null || z == "") {alert("college must be filled out.");return false;}var x = document.forms["form"]["email"].value;var atpos = x.indexOf("@");
var dotpos = x.lastIndexOf(".");if (atpos<1 || dotpos<atpos+2 || dotpos+2>=x.length) {alert("Not a valid e-mail address.");return false;}var a = document.forms["form"]["password"].value;if(a == null || a == ""){alert("Password must be filled out");return false;}if(a.length<5 || a.length>25){alert("Passwords must be 5 to 25 characters long.");return false;}
var b = document.forms["form"]["cpassword"].value;if (a!=b){alert("Passwords must match.");return false;}
if(mob.length!==10){alert("enter valid mobile no.");return false;}
}
</script> -->
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Fullname" class="form-control input-md" type="text" pattern="[a-zA-Z]{1,}" required>
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="college" name="college" placeholder="College Name" class="form-control input-md" type="text" required>
...
<div class="form-group">
  ...
  <div class="col-md-12">
    <input id="email" name="email" placeholder="Email ID" class="form-control input-md" type="email" required>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="mob" name="mob" placeholder="Contact Number" class="form-control input-md" type="tel" pattern="[0-9]{10}"required>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="" width=100 height=100 alt="loading.." class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Charul Mauni,Akshit Kandpal</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+919999999999</h4>
		<h4 style="font-family:'typo' ">charulmauni@gmail.com</h4>
		<h4 style="font-family:'typo' ">Graphic Era Hill University,Bhimtal</h4></div></div>
		</p>
      </div>
